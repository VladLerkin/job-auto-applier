# job-auto-applier (Auto Resume Filler)

See what's new in the [Release Notes](RELEASE_NOTES.md).
## Зачем нужна эта программа
**Auto Resume Filler** — это инструмент, предназначенный для автоматического заполнения форм отклика на вакансии. Он анализирует ваш профиль и резюме (CV), и с помощью искусственного интеллекта (Gemini API) самостоятельно подставляет нужную информацию в поля формы на сайтах с вакансиями. Это экономит время и избавляет от рутинной работы.
...
2. **Установка расширения в Chrome:**
   ...
   - Нажмите **Загрузить распакованное расширение** (Load unpacked) и выберите корневую папку этого проекта.
...
- Кликните на иконку расширения Auto Resume Filler.
...
* **Your Profile / Preferences:** Ваши предпочтения или дополнительная информация профиля (например, желаемая зарплата, формат работы, уровень seniority).
